...
namespace FootballTyperAPI.Controllers
{
    ...
    public class ScoreController : ControllerBase
    {
        ...
        public IActionResult GetLastDayRanking(string league)
        {
            ...
            var lastDayBets = bets.Where(x => users.Select(y => y.Username).Contains(x.BettorUserName) && x.Match.Date.DayOfYear == DateTime.Today.DayOfYear);
        ...
        {
            var lastUpdateDate = _context.Bets.Max(x => x.BetProcessedDate).ToUniversalTime();
